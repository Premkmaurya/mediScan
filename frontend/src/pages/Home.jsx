...
import { FaPlus, FaSpinner, FaFilePdf, FaImage } from "react-icons/fa6"; // Added FaSpinner, FaFilePdf, FaImage
...
export default function Home() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md h-[700px] bg-white rounded-lg shadow-xl flex flex-col overflow-hidden">
        <header className="p-4 bg-teal-600 text-white border-b border-gray-200">
        ...
        <footer className="p-4 bg-gray-100 border-t border-gray-200">
          ...
          <form onSubmit={handleSend} className="flex gap-2">
            ...
            <input
              ...
              placeholder={
                fileUpload
                  ? `File selected: ${fileUpload.name}. Type optional message.`
                  : "Type a message..."
              }
